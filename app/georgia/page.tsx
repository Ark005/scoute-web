            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              >
                <div className="relative aspect-[3/4] bg-gray-100 overflow-hidden">
                  <Image
                    src="https://scoute.app/media/route_covers/georgia-wine-kakheti.png"
                    alt="Кахетия"
                    fill
