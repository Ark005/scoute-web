    ...
    <main className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="space-y-6 text-[15px] leading-relaxed text-gray-700">
        ...
        <section>
          ...
          <p className="mt-2">
            При переходе по ссылкам на партнёрские сервисы (Aviasales, Ostrovok,
            GetYourGuide, Localrent) пользователь покидает Сервис, и применяются
            правила и политики конфиденциальности этих сервисов. Платёжные данные,
            паспортные данные, email и контакты пользователь вводит на стороне партнёра —
            scoute.app их не получает и не хранит.
          </p>
          <p className="mt-2">
            Сервис работает по affiliate-модели и может получать комиссию от партнёра
            за переход и/или совершённую покупку. Рекламные блоки маркированы
            «Реклама» в соответствии с 18-ФЗ. ОРД-посредник по партнёрским ссылкам —
            Travelpayouts (домен emrld.ltd), рекламодатель — Go Travel Un Limited
            (ИНН 9909520797).
          </p>
          <p className="mt-2">
            При нажатии на кнопку «Купить» в URL партнёра подставляются только
            параметры поездки: код города отправления и прибытия, даты, количество
            пассажиров. Это <strong>не персональные данные</strong>. ФИО, паспорт,
            email, телефон, платёжные данные scoute.app не собирает и партнёру не передаёт —
            пользователь вводит их самостоятельно на сайте партнёра.
          </p>
        </section>
